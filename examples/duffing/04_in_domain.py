...
if train == True:
    ...
    # Save the data
    np.save(run_folder+"train_data.npy", train_data)
    np.save(run_folder+"test_data.npy", test_data)
    ...
    train_data = np.load(run_folder+"train_data.npy")
    test_data = np.load(run_folder+"test_data.npy")
...
ax1.set_ylabel(r'$y$')
ax2.set_ylabel(r'$y$')
ax1.set_title('Phase Space - System 1')
ax2.set_title('Phase Space - System 2')
